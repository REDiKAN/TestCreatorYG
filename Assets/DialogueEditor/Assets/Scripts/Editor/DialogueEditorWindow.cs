...
namespace TestEditor
{
    public class DialogueEditorWindow : EditorWindow
    {
        ...
        private const string HELP_URL = "https://docs.google.com/document/d/1888RgK1VbJz3nwJQ_TqFYEvumUSTxCUTsMVaJmvsDdo/edit?usp=sharing";
        ...
        {
            return EditorWindow.GetWindow<DialogueEditorWindow>("Test Editor");
        }
